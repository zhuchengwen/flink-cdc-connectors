...
public class SqlserverTableSouceTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(CREATE_PRINT);
    ...
    public static final String CREATE_SQL =
            "create table customer_CustomerBO (\n"
                    + "id int  ,\n"
                    + "name string,\n"
                    + "age int ,\n"
                    + "area int"
    ...
    public static final String CREATE_PRINT =
            "create table dim_customer_customerbo_delta_sync_raw (\n"
                    + "id int  ,\n"
                    + "name string,\n"
                    + "age int ,\n"
                    + "area int "
    ...
    public static final String INSERT =
            "insert into dim_customer_customerbo_delta_sync_raw\n"
                    + "select "
                    + "`id`,\n"
                    + "`name`,\n"
                    + "`age`,\n"
